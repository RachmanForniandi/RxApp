...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable.just("List products & Prices").subscribe(tV1::setText);
        ...
        Observable.just(entry1,entry2,entry3,entry4,entry5).subscribe(entry -> rxAdapter.addStringToList(entry));
